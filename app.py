...
""")
        ...
        # -----------------------------
         ...
         with col1:
          ...
          bar_img_buffer.write(bar_fig.to_image(format="png"))
        ...
        with col2:
            ...
            pie_img_buffer.write(pie_fig.to_image(format="png"))
        ...
        elements.append(Paragraph("Medical Recommendations", heading_style))
         # Define recommendations based on prediction probability
        if prob_positive >= 70:
         recs_for_pdf = [
        "Consult a healthcare professional immediately",
        "Get complete diabetes screening",
        "Monitor blood sugar regularly",
        "Adopt strict diet and exercise plan"
    ]
        elif prob_positive >= 30:
         recs_for_pdf = [
